...
const PaginationLink = function PaginationLink({ className, isActive, size = "icon", ...props }) {
  return (
    <a
...
const PaginationPrevious = function PaginationPrevious({ className, ...props }) {
  return (
    <PaginationLink
...
const PaginationEllipsis = function PaginationEllipsis({ className, ...props }) {
  return (
    <span
      aria-hidden
